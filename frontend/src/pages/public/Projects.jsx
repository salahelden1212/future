        ...
        <div className="container mx-auto px-4">
                ...
                >
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-gradient-to-r from-brand-500 to-brand-400 rounded-xl"
          ...
          >
            <span className="text-gray-500">
              {isArabic ? 'عرض' : 'Showing'} <span className="text-brand-400 font-bold">{filteredProjects.length}</span> {isArabic ? 'مشروع' : 'projects'}
            </span>
          </motion.div>
              ...
              {filteredProjects.map((project, index) => (
                ...
                >
                  <Link to={`/projects/${project._id}`} className="block">
                    <div className="relative bg-gradient-to-br from-gray-800/90 to-gray-900/90 rounded-2xl overflow-hidden border border-gray-700/50 hover:border-brand-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-brand-500/10">
                      {/* Image Container */}
                      <div className="relative h-72 overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                          <motion.div
                            initial={{ scale: 0.8 }}
                            whileHover={{ scale: 1 }}
                            className="bg-gradient-to-r from-brand-500 to-brand-400 text-gray-900 px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg"
                          >
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-700/50">
                          ...
                          <div className="flex items-center gap-2 text-brand-400 font-medium text-sm group-hover:gap-3 transition-all duration-300">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-500 via-brand-400 to-brand-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                    </div>
                  </Link>
                </motion.div>
              ))}
